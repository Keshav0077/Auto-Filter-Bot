...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7045947967').split()] 
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002312706219'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002520222866')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002875861092') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002491588102') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cinemahub:F7Pw4KMgkQa3Mx2r@cluster0.wycanos.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002799537836 -1002875861092 -1002409869914 -1002488086781") # add multiple channels here, separated by single space
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002461306484'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/moviesbazaarsupp') 
...
EMOJI_MODE = bool(environ.get('EMOJI_MODE', )) 
...
if HAS_SSL:
    URL = "https://metropolitan-clarabelle-keshavraj-ae865aa7.koyeb.app/".format(FQDN)
else:
    URL = "https://metropolitan-clarabelle-keshavraj-ae865aa7.koyeb.app/".format(FQDN)
